...
# LED
#============================================================
set_location_assignment PIN_W15 -to DATA_OUT_DUMMY
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to DATA_OUT_DUMMY
...
#============================================================
set_location_assignment PIN_V12 -to DATA_IN[0]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to DATA_IN[0]
set_location_assignment PIN_AF7 -to DATA_IN[1]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to DATA_IN[1]
set_location_assignment PIN_W12 -to DATA_IN[2]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to DATA_IN[2]
set_location_assignment PIN_AF8 -to DATA_IN[3]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to DATA_IN[3]
set_location_assignment PIN_Y8 -to DATA_IN[4]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to DATA_IN[4]
set_location_assignment PIN_AB4 -to DATA_IN[5]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to DATA_IN[5]
set_location_assignment PIN_W8 -to DATA_IN[6]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to DATA_IN[6]
set_location_assignment PIN_Y4 -to DATA_IN[7]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to DATA_IN[7]
set_location_assignment PIN_Y5 -to TRIG_IN
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to TRIG_IN
set_location_assignment PIN_U11 -to CAP_CLK
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to CAP_CLK
# set_location_assignment PIN_T8 -to CAP_CLK
# set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to CAP_CLK
